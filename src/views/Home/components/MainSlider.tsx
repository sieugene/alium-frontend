...
const CyberCitySlide = styled(({ className }) => {
  ...
  return (
    <Slide className={className}>
      <SlideTitle>{t('Genesis NFT Drop is Live!')}</SlideTitle>
      <SlideDescription>
        {t('Play to Earn Game with open economy and 10 000 cool and exciting Cyberpunk NFT Characters')}
      </SlideDescription>
      <SlideAction as='a' href='https://cybercity.game/' target='_blank' rel='noreferrer noopener'>
        {t('Learn more')}
      </SlideAction>
    </Slide>
  )
