...
const BSC_HECO_OVERRIDES = {}
const BSC_POLYGON_TEST_OVERRIDES = {}
const BSC_POLYGON_OVERRIDES = {}
const BSC_ROPSTEN_OVERRIDES = {}
const BSC_RINKEBY_OVERRIDES = {}
...
const OVERRIDES = {
  ...
  [BSC_HECO_BRIDGE]: BSC_HECO_OVERRIDES,
  [BSC_POLYGON_TEST_BRIDGE]: BSC_POLYGON_TEST_OVERRIDES,
  [BSC_POLYGON_BRIDGE]: BSC_POLYGON_OVERRIDES,
