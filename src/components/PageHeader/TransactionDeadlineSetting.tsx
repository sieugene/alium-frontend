...
const TransactionDeadlineSetting = () => {
  ...
  return (
    <StyledTransactionDeadlineSetting>
      <Label>
        <Text style={{ fontWeight: 600 }}>{t('swap.settingsModal.transactionDeadline')}</Text>
        <QuestionHelper text={t('swap.settingsModal.transactionRevertPending')} />
      </Label>
      <Field>
        <Numeric
          type='number'
        ...
        />
        <Text color={theme.colors.textSubtle}>{t('swap.settingsModal.minutes')}</Text>
      </Field>
      {error && (
